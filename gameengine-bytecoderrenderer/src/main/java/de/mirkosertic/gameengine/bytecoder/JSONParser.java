...
public class JSONParser {
    ...
    public interface TokenHandler<T> {
        ...
        TokenHandler handleSingleCharacter(char aChar);
    ...
    public class ListProducingTokenHandler implements TokenHandler<List<Map<String, Object>>> {
        ...
        @Override
        public TokenHandler handleSingleCharacter(char aChar) {
            switch (aChar) {
                case '{':
    ...
    public class MapProducingTokenHandler implements TokenHandler<Map<String, Object>> {
        ...
        @Override
        public TokenHandler<? extends Object> handleSingleCharacter(char aChar) {
            if (inString) {
                if (escapeNext) {
                    escapeNext = false;
                    switch (aChar) {
    ...
    public <T> T fromJSON(String aValue) {
        ...
        for (int i=0;i<aValue.length();i++) {
            ...
            theHandler = theHandler.handleSingleCharacter(theChar);
        }
