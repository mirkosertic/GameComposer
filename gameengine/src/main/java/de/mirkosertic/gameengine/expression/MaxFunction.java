...
class MaxFunction implements Function<Number> {
    ...
    public Number evaluate(Object[] aArguments) {
        ...
        if (theNumber1 instanceof Integer) {
            return Math.max(theNumber1.intValue(), theNumber2.intValue());
        }
        return Math.max(theNumber1.doubleValue(), theNumber2.doubleValue());
    }
}
