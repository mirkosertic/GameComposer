...
public class GameObjectElementConfigurator implements ObjectInspectorElementConfigurator<GameObject> {
    ...
    public List<PropertySheet.Item> getItemsFor(GameObject aObject) {
        ...
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.nameProperty(), "Name", "The name of the object", Optional.of(StringPropertyEditor.class)));
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.sizeProperty(), "Size", "The size of the object", Optional.of(SizePropertyEditor.class)));
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.visibleProperty(), "Visible", "The visibility of the object"));
        return theResult;
    }
}