...
public class GameSceneElementConfigurator implements ObjectInspectorElementConfigurator<GameScene> {
    ...
    public List<PropertySheet.Item> getItemsFor(GameScene aObject) {
        ...
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.nameProperty(), "Name", "The name of the scene", Optional.of(StringPropertyEditor.class)));
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.cameraObjectProperty(), "Camera", "The default camera object", Optional.of(GameObjectPropertyEditor.class)));
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.defaultPlayerProperty(), "Default player", "The default player object", Optional.of(GameObjectPropertyEditor.class)));
        theResult.add(new PropertyEditorItem<>(editorContext, CATEGORY_NAME, aObject.backgroundColorProperty(), "Background color", "The scene background color", Optional.of(ColorPropertyEditor.class)));
